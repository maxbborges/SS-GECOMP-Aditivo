function servicetask218(attempt, message) {
	...
	try {
		...
		var indexesPrazoQuantidade = hAPI.getChildrenIndexes('tbl_17_geral');

		for (var j = 0; j < indexesPrazoQuantidade.length; j++) {
			var idLinePrazoQuantidade = parseInt(j) + 1;
			
			var NUMCNPJ = hAPI.getCardValue('txt_entidade_17___'+idLinePrazoQuantidade) //'73471989000195'; VERIFICA SE O CNPJ E SEST OU SENAT
			...
			var contrato = hAPI.getCardValue('txt_nProcesso_17___'+idLinePrazoQuantidade); //'000000000004627';
			...
			if (prazoQuantidade001 == 'Sim') {
				...
				var justificativa = hAPI.getCardValue('atxt_19_objAditivo2') //'TESTE FLUIG TREGUAS';
				...
				var dataObj = [{
						"CN9_VIGE": hAPI.getCardValue('txt_novaVigencia_19___'+idLinePrazoQuantidade) //Vigencia do Contrato ex. '12'
					},
					{
						"CN9_UNVIGE": hAPI.getCardValue('cb_vigencia_19___'+idLinePrazoQuantidade), //Unidade de Vigencia ex. '2'
					},
					{
						"SubItem1": subItem,
					}
			...
			if (reajuste003 == 'Sim') {
				...
				var dataReajuste = hAPI.getCardValue('txt_dtReajuste_20___'+idLinePrazoQuantidade);
				var refReajuste = hAPI.getCardValue('txt_refReajuste_20___'+idLinePrazoQuantidade);
			...
			if (realinhamento008 == 'Sim') {
				...
				var cn9Numero = hAPI.getCardValue('txt_nProcesso_17___'+idLinePrazoQuantidade); //NUMERO DO PROCESSO
